...
export type Sound = [string, string, number];
export type Sounds = Sound[];

export const sounds: Sounds = [
	['สวัสดีครับ', 'sà-wàt-dee kráp.mp3', 1.35],
	['ท่านสมาชิก', 'tân sà-maa-chík.mp3', 1.35],
	['ชมรมคนชอบหมี', 'chom-rom kon chôp mĕe.mp3', 1.35],
	['วันพระวันเจ้าไม่เว้นกันเล้ย', 'wan prá wan jâo mâi wáyn gan lóie.mp3', 3.6],
	['อยากจะดูแต่หมี', 'yàak jà doo dtàe mĕe.mp3', 1.5],
	['ทั้งเด็กทั้งผู้ใหญ่', 'táng dèk táng pôo yài.mp3', 1.36],
	['ตะโกนหาสรรหา', 'dtà-gohn hăa săn-hăa.mp3', 1.75],
	['ตะโกนหาสรรหาแต่หมี', 'dtà-gohn hăa săn-hăa dtàe mĕe.mp3', 2.55],
	['ไม่เข้าใจ', 'mâi kâo jai.mp3', 1.9],
	['ไม่เข้าใจเลยจริงๆ เลย', 'mâi kâo jai loie jing jing loie.mp3', 1.9],
	['เห้ย', 'hôie.mp3', 1.1],
	['ทั้งวันเลยวันเนี่ย', 'táng wan loie wan nîa.mp3', 1.3],
	['ทำงานมีแต่หมีโผล่มาทั้งวันเลย', 'tam ngaan mee dtàe mĕe plòh maa táng wan loie.mp3', 2.9],
	['ส่งไปให้แล้วก็ยังจะให้ดูอีก', 'sòng bpai hâi láew gôr yang jà hâi doo èek.mp3', 1.8],
	[
	...
	['เห้ย ตายแล้ว', 'hôie dtaai láew.mp3', 1.48],
	[
	...
	['ดูกันมั่งหรือเปล่า', 'doo gan mâng rĕu bplào.mp3', 1.26],
	['ดูแต่หมี', 'doo dtàe mĕe.mp3', 1.26],
	['วันพระใหญ่นะ', 'wan-prá-yài ná.mp3', 1.44],
	['หมีระงบกันทั้งวันทั้งคืนเลย', 'mĕe rá ngóp gan táng wan táng keun loie.mp3', 2.4],
	['ไม่เข้าใจเลย พวกท่านเป็นยังไง', 'mâi kâo jai loie pûak tân bpen yang ngai.mp3', 2.4],
	['จัดมาดิ์ เอาแบบเบิ้มๆ น่ะ คือลือน่ะ', 'jàt maa ao bàep-bêrm nâ keu leu nâ.mp3', 4.92],
	['เป็นอะไรกัน', 'bpen à-rai gan.mp3', 1.26],
	['ผมไม่เข้าใจจริงเลย', 'pŏm mâi kâo jai jing loie.mp3', 4.12],
	[
	...
	['ทำงานทั้งวันละหมีโผล่ทั้งวันเลย', 'tam ngaan táng wan lá mĕe plòh táng wan loie.mp3', 3.56],
	['ผมไม่เข้าใจเลยจริงๆ', 'pŏm mâi kâo jai loie jing jing.mp3', 4.4],
	[
	...
	['เจริญในธรรม', 'jà-rern nai tam.mp3', 0.5],
	['ท่านผู้เจริญซึ่งมากไปด้วยปัญญา', 'tân pôo jà-rern sêung mâak bpai dûay bpan-yaa.mp3', 2.4],
	[
	...
	['นี้เป็นการสอนธรรมะนะผู้เจริญ', 'née bpen gaan sŏn tam-má ná pôo jà-rern.mp3', 3.5],
	['ธรรมะกระตุกจิดกระชากใจ', 'tam-má grà-dtùk jì-dòk rá chaa jai.mp3', 2.5],
	['มันเป็นแบบนี้ ต้องมีอุปกรณ์', 'man bpen yàang née dtông mee ù-bpà-gon.mp3', 2.7],
	['หยิบออกมา หยิบออกมา', 'yìp òk maa yìp òk maa.mp3', 3.6],
	[
		'เห็นแล้วยัง ที่เห็นนี้คือ พลาสติก ที่แขวงผ้า',
		'hĕn láew yang têe hĕn née keu pláat-dtìk têe kwăeng pâa.mp3',
		8
	],
	['มีหมีมีนมนิ', 'mee hĕe meen-má-née.mp3', 1.5],
	[
		'นี้เป็นการแสดงให้ดูนะท่านผู้เจริญ',
		'née bpen gaan sà-daeng hâi doo ná tân pôo jà-rern.mp3',
		3.0
	],
	['แบบนี้เรียกว่าชนฉิ่งตีฉิ่ง', 'bàep née rîak wâa chon chìng dtee-chìng.mp3', 3.7],
	['ท่าทางอย่างนี้เรียกว่ากระเด้าคู่', 'tâa taang yàang née rîak wâa grà dâo kôo.mp3', 3.85],
	['กระเด้าคนนี้ที่ กระเด้าคนนี้ที', 'grà dâo-kon-née têe grà dâo-kon-née tee.mp3', 3.25],
	['มันดีไหม?', 'man dee măi.mp3', 0.8],
	['ท่าอย่างนี้เรียกว่าดูดนม', 'tâa yàang née rîak wâa dòot nom.mp3', 2.5],
	['ดูดนมหน่อย', 'dòot nom nòi.mp3', 2],
	['ดูดขวาดูดซ้าย', 'dòot kwăa dòot sáai.mp3', 6.1],
	['แบบนี้เรียกว่าเลียหมี', 'bàep née rîak wâa lia hĕe.mp3', 8.5],
	['เพราะหมีมันหอมดี', 'prór hĕe man hŏm dee.mp3', 2],
	['กูมีสองหมี', 'goo mee sŏng-hĕe.mp3', 2],
	['ดับเบิ้ลหมี', 'dàp-bêrn hĕe.mp3', 1],
	[
	...
	[
		...
		'trong née kor hĕe hĕe trong nun kor hĕe hĕe nee kor hĕe nun kor hĕe took took tée kor hĕe hĕe.mp3',
		5.5
	],
